...
namespace IIS.Poslednijj
{
    ...
    public class Товары : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Poslednijj.ЕдИзм fЕдиницыИзмер;
        ...
        public virtual IIS.Poslednijj.ЕдИзм ЕдиницыИзмер
        {
            get
            {
                ...
                IIS.Poslednijj.ЕдИзм result = this.fЕдиницыИзмер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыE", typeof(IIS.Poslednijj.Товары));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыL", typeof(IIS.Poslednijj.Товары));
                }
            }
        }
    }
